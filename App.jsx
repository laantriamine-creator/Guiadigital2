...
const LEGAL_CONTENT = {
  "aviso-legal": {
    title: "Aviso Legal",
    sections: [
      { heading: "Datos identificativos del titular", text: "El sitio web puraclaridad.com (en adelante, el «Sitio Web») es operado por:\n\nTitular: LAANTRI MARKETING LLC\nForma jurídica: Limited Liability Company (LLC) constituida conforme a las leyes del Estado de Wyoming, Estados Unidos de América.\nDomicilio social: 1309 Coffeen Avenue STE 1200, Sheridan, Wyoming 82801, Estados Unidos.\nEmail de contacto: contact@awakergy.com\nMarca comercial: PuraClaridad\nActividad: Venta de productos digitales educativos relacionados con salud ambiental y reducción de la exposición a microplásticos." },
      { heading: "Objeto y ámbito de aplicación", text: "El presente Aviso Legal regula el uso del Sitio Web puraclaridad.com, operado por LAANTRI MARKETING LLC (en adelante, «el Titular»). La navegación por el Sitio Web atribuye la condición de usuario e implica la aceptación plena y sin reservas de todas y cada una de las disposiciones incluidas en este Aviso Legal, así como en la Política de Privacidad, la Política de Cookies y los Términos y Condiciones." },
      { heading: "Propiedad intelectual e industrial", text: "Todos los contenidos del Sitio Web, incluyendo textos, fotografías, gráficos, imágenes, iconos, tecnología, software, diseños, ilustraciones, código fuente y la guía digital «Reduce Tu Exposición a Microplásticos en 21 Días», así como la marca PuraClaridad y cualquier otro signo distintivo, son propiedad de LAANTRI MARKETING LLC o de terceros que han autorizado su uso, y están protegidos por las leyes de propiedad intelectual e industrial aplicables.\n\nQueda expresamente prohibida la reproducción, distribución, comunicación pública, transformación o cualquier otra forma de explotación de estos contenidos sin autorización expresa y por escrito del Titular. La compra de la guía digital otorga una licencia de uso personal e intransferible." },
      { heading: "Exclusión de responsabilidad", text: "El contenido de este Sitio Web y de los productos digitales ofrecidos tiene fines exclusivamente educativos e informativos. No constituye asesoramiento médico, diagnóstico ni tratamiento. Ante cualquier duda sobre su salud, consulte siempre con un profesional sanitario cualificado.\n\nEl Titular no se hace responsable de las decisiones que el usuario tome basándose en la información proporcionada, ni de los resultados derivados de la aplicación de las recomendaciones contenidas en los productos digitales. El usuario asume la responsabilidad del uso del Sitio Web y de los contenidos adquiridos." },
      { heading: "Enlaces a terceros", text: "El Sitio Web puede contener enlaces a webs de terceros. El Titular no se hace responsable del contenido, las prácticas de privacidad ni de cualquier daño o pérdida derivados del uso de dichas webs externas." },
      { heading: "Legislación aplicable y jurisdicción", text: "El presente Aviso Legal se rige por las leyes del Estado de Wyoming, Estados Unidos. No obstante, cuando el usuario tenga la condición de consumidor con residencia habitual en la Unión Europea, se respetarán los derechos irrenunciables que le reconozca la legislación imperativa de su país de residencia, incluyendo la normativa europea de protección al consumidor.\n\nPara cualquier controversia, las partes podrán acudir a los órganos de resolución alternativa de conflictos disponibles, incluida la plataforma de resolución de litigios en línea de la Comisión Europea (https://ec.europa.eu/consumers/odr)." },
    ],
  },
  "privacidad": {
    title: "Política de Privacidad",
    sections: [
      { heading: "Responsable del tratamiento", text: "Responsable: LAANTRI MARKETING LLC\nDomicilio: 1309 Coffeen Avenue STE 1200, Sheridan, Wyoming 82801, Estados Unidos.\nEmail: contact@awakergy.com\n\nLAANTRI MARKETING LLC, como operadora del sitio web puraclaridad.com, es responsable del tratamiento de los datos personales que el usuario facilita a través del Sitio Web." },
      { heading: "Datos que recogemos", text: "Recogemos los siguientes datos personales:\n\n• Datos de contacto: dirección de correo electrónico (facilitada al realizar el test o al comprar la guía).\n• Datos de la compra: importe, fecha y método de pago (procesados directamente por Stripe, nuestro proveedor de pagos).\n• Datos de navegación: dirección IP, tipo de dispositivo, navegador y páginas visitadas, obtenidos mediante cookies y tecnologías similares.\n• Respuestas del test de exposición: datos facilitados voluntariamente para generar un resultado personalizado.\n\nNo solicitamos ni almacenamos datos bancarios ni de tarjetas de crédito. Todos los pagos se procesan a través de Stripe (https://stripe.com/es/privacy)." },
      { heading: "Finalidad y base legal del tratamiento", text: "Tratamos sus datos con las siguientes finalidades:\n\n• Ejecución del contrato: envío de la guía digital adquirida y gestión de la compra (base legal: ejecución de un contrato).\n• Comunicaciones comerciales: envío de correos electrónicos con información y ofertas relacionadas con PuraClaridad, únicamente si el usuario ha prestado su consentimiento (base legal: consentimiento).\n• Atención al cliente: respuesta a consultas y solicitudes de devolución (base legal: ejecución de un contrato e interés legítimo).\n• Cumplimiento de obligaciones legales y fiscales (base legal: obligación legal).\n• Análisis de uso del Sitio Web y mejora del servicio (base legal: interés legítimo)." },
      { heading: "Transferencias internacionales de datos", text: "LAANTRI MARKETING LLC tiene su sede en Estados Unidos. Al facilitar sus datos a través del Sitio Web, el usuario reconoce que estos pueden ser transferidos y tratados en Estados Unidos, un país fuera del Espacio Económico Europeo.\n\nPara garantizar un nivel adecuado de protección de los datos personales de usuarios residentes en la Unión Europea, aplicamos las salvaguardas previstas en el Reglamento General de Protección de Datos (RGPD), incluyendo cláusulas contractuales tipo aprobadas por la Comisión Europea cuando resulte aplicable.\n\nAsimismo, algunos de nuestros proveedores (Stripe, Meta, proveedores de email marketing y hosting) pueden tratar datos en diferentes jurisdicciones bajo sus propias garantías de cumplimiento del RGPD." },
      { heading: "Conservación de los datos", text: "Conservamos los datos personales durante el tiempo necesario para cumplir la finalidad para la que fueron recogidos y para atender las posibles responsabilidades legales, fiscales y contables derivadas. Los datos de facturación se conservan durante el período legalmente exigido. Los datos de suscriptores a comunicaciones comerciales se conservan hasta que el usuario retire su consentimiento." },
      { heading: "Derechos del interesado", text: "De conformidad con el Reglamento General de Protección de Datos (RGPD) y demás normativa aplicable, el usuario puede ejercer los siguientes derechos:\n\n• Derecho de acceso a sus datos personales.\n• Derecho de rectificación de datos inexactos.\n• Derecho de supresión («derecho al olvido»).\n• Derecho a la limitación del tratamiento.\n• Derecho a la portabilidad de los datos.\n• Derecho de oposición al tratamiento.\n• Derecho a retirar el consentimiento en cualquier momento.\n• Derecho a presentar una reclamación ante una autoridad de control competente (en España, la Agencia Española de Protección de Datos — www.aepd.es).\n\nPara ejercer estos derechos, puede escribir a contact@awakergy.com indicando en el asunto «Ejercicio de derechos RGPD» y adjuntando una copia de un documento que acredite su identidad." },
      { heading: "Seguridad de los datos", text: "Aplicamos medidas técnicas y organizativas razonables para proteger los datos personales contra el acceso no autorizado, la pérdida, la alteración o la divulgación. Los pagos se procesan de forma cifrada por Stripe, y el Sitio Web utiliza conexión HTTPS." },
    ],
  },
  "cookies": {
    title: "Política de Cookies",
    sections: [
      { heading: "¿Qué son las cookies?", text: "Las cookies son pequeños archivos de texto que los sitios web almacenan en el dispositivo del usuario cuando los visitan. Permiten al Sitio Web reconocer al usuario, recordar sus preferencias y analizar el uso que hace del mismo, con el objetivo de mejorar la experiencia de navegación." },
      { heading: "Tipos de cookies que utilizamos", text: "El sitio web puraclaridad.com utiliza los siguientes tipos de cookies:\n\n• Cookies técnicas (necesarias): imprescindibles para el funcionamiento del Sitio Web, el proceso de compra y el envío de la guía digital. No requieren consentimiento.\n\n• Cookies analíticas: nos permiten conocer de forma anónima cómo los usuarios interactúan con el Sitio Web (páginas visitadas, tiempo de permanencia, origen del tráfico). Utilizamos proveedores como Google Analytics.\n\n• Cookies de marketing y publicidad: permiten medir la eficacia de nuestras campañas publicitarias y mostrar anuncios relevantes. Utilizamos el píxel de Meta (Facebook/Instagram) para el seguimiento de conversiones de las campañas de Meta Ads.\n\n• Cookies de terceros: Stripe utiliza sus propias cookies para procesar pagos de forma segura." },
      { heading: "Gestión y desactivación de cookies", text: "El usuario puede aceptar, rechazar o configurar el uso de cookies en cualquier momento a través del banner de consentimiento que aparece al acceder al Sitio Web por primera vez.\n\nAsimismo, puede configurar su navegador para bloquear o eliminar cookies. A continuación se indican los enlaces a las instrucciones de los principales navegadores:\n\n• Google Chrome: https://support.google.com/chrome/answer/95647\n• Mozilla Firefox: https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies\n• Safari: https://support.apple.com/es-es/guide/safari/sfri11471/mac\n• Microsoft Edge: https://support.microsoft.com/es-es/microsoft-edge\n\nTenga en cuenta que bloquear las cookies técnicas puede impedir el funcionamiento correcto del Sitio Web y del proceso de compra." },
    ],
  },
  "terminos": {
    title: "Términos y Condiciones",
    sections: [
      { heading: "Identificación del vendedor", text: "Vendedor: LAANTRI MARKETING LLC\nDomicilio: 1309 Coffeen Avenue STE 1200, Sheridan, Wyoming 82801, Estados Unidos.\nEmail: contact@awakergy.com\nSitio Web: puraclaridad.com\n\nLAANTRI MARKETING LLC opera la marca PuraClaridad y es responsable de la venta de productos digitales a través del Sitio Web." },
      { heading: "Objeto", text: "Los presentes Términos y Condiciones regulan la adquisición de productos digitales ofrecidos a través del sitio web puraclaridad.com, en particular la guía digital «Reduce Tu Exposición a Microplásticos en 21 Días» (en adelante, «la Guía»). Al realizar una compra, el usuario acepta íntegramente estos términos." },
      { heading: "Descripción del producto y precio", text: "La Guía es un producto digital en formato PDF, de aproximadamente 24 páginas, que incluye un plan de acción de 21 días, checklists imprimibles, un glosario de términos y un bonus con tiendas y marcas disponibles en España.\n\nEl precio de la Guía es de 9,90 € (IVA incluido, cuando resulte aplicable). Los precios mostrados en el Sitio Web son los vigentes en el momento de la compra. El usuario recibe la Guía de forma digital e inmediata tras completar el pago." },
      { heading: "Proceso de compra y pago", text: "Para adquirir la Guía, el usuario debe completar el proceso de pago a través de Stripe, nuestro proveedor de pagos seguro. Se aceptan los métodos de pago disponibles en Stripe Checkout, principalmente tarjetas de crédito y débito.\n\nUna vez confirmado el pago, el usuario recibirá acceso inmediato a la descarga de la Guía en la página de confirmación, así como una copia por correo electrónico.\n\nLAANTRI MARKETING LLC no almacena datos de tarjetas de crédito. Todo el procesamiento de pagos es gestionado por Stripe conforme a sus propios términos y política de privacidad." },
      { heading: "Derecho de desistimiento — productos digitales", text: "De conformidad con el artículo 103.m) del Real Decreto Legislativo 1/2007, de 16 de noviembre, por el que se aprueba el texto refundido de la Ley General para la Defensa de los Consumidores y Usuarios (y normativa equivalente europea), el derecho de desistimiento NO es aplicable al suministro de contenido digital que no se preste en un soporte material cuando la ejecución haya comenzado con el previo consentimiento expreso del consumidor y con el conocimiento por su parte de que, en consecuencia, pierde su derecho de desistimiento.\n\nAl completar la compra y descargar la Guía, el usuario reconoce expresamente que la prestación del servicio comienza inmediatamente y renuncia a su derecho de desistimiento legal de 14 días." },
      { heading: "Garantía de satisfacción de 30 días", text: "No obstante lo anterior, LAANTRI MARKETING LLC ofrece de forma voluntaria una garantía comercial de satisfacción de 30 días. Si dentro de los 30 días naturales siguientes a la compra el usuario no queda satisfecho con la Guía, puede solicitar la devolución íntegra del importe escribiendo a contact@awakergy.com desde la dirección de email utilizada en la compra, indicando el motivo.\n\nEl reembolso se realizará mediante el mismo método de pago utilizado en la compra, en un plazo máximo de 14 días desde la aceptación de la solicitud. Esta garantía es una liberalidad comercial y no sustituye ni limita los derechos legales irrenunciables del consumidor." },
      { heading: "Responsabilidad y uso de la información", text: "La información contenida en la Guía tiene carácter exclusivamente educativo e informativo. No constituye asesoramiento médico, diagnóstico ni tratamiento. El usuario debe consultar con un profesional sanitario cualificado ante cualquier duda relativa a su salud.\n\nLAANTRI MARKETING LLC no se hace responsable de las decisiones tomadas por el usuario basándose en el contenido de la Guía ni de los resultados obtenidos tras aplicar las recomendaciones." },
      { heading: "Licencia de uso", text: "La compra de la Guía otorga al usuario una licencia de uso personal, intransferible y no exclusiva. Queda expresamente prohibida la reproducción, distribución, comunicación pública, reventa o cualquier otra forma de explotación comercial del contenido sin autorización expresa y por escrito del Titular." },
      { heading: "Atención al cliente y reclamaciones", text: "Para cualquier consulta, reclamación o ejercicio de garantía, el usuario puede escribir a contact@awakergy.com. Responderemos en un plazo máximo de 48 horas laborables.\n\nLos consumidores residentes en la Unión Europea pueden acceder a la plataforma de resolución de litigios en línea de la Comisión Europea: https://ec.europa.eu/consumers/odr" },
      { heading: "Legislación aplicable", text: "Los presentes Términos y Condiciones se rigen por las leyes del Estado de Wyoming, Estados Unidos. No obstante, cuando el usuario sea consumidor con residencia habitual en la Unión Europea, se respetarán los derechos irrenunciables que le reconozca la legislación imperativa de protección al consumidor de su país de residencia." },
    ],
  },
  "contacto": {
    title: "Contacto",
    sections: [
      { heading: "Titular", text: "LAANTRI MARKETING LLC\n1309 Coffeen Avenue STE 1200\nSheridan, Wyoming 82801\nEstados Unidos\n\nMarca comercial: PuraClaridad" },
      { heading: "Email", text: "contact@awakergy.com\n\nEs la forma más rápida de contactar con nosotros. Respondemos a consultas, solicitudes de garantía y cualquier pregunta sobre la guía digital en un plazo máximo de 48 horas laborables." },
      { heading: "Motivos habituales de contacto", text: "• Problemas con la descarga de la guía.\n• Solicitudes de reembolso dentro de la garantía de 30 días.\n• Consultas sobre el contenido de la guía.\n• Ejercicio de derechos RGPD (acceso, rectificación, supresión, etc.).\n• Cuestiones legales o de facturación.\n\nAl escribirnos, incluye en el asunto el motivo de tu consulta para que podamos atenderte con la mayor rapidez." },
    ],
  },
};
